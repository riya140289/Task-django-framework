    ...
    def post(self, request):
        ...
        try:
            ...
            if user_obj:
                ...
                response['status'] = 200
                response['message'] = 'Welcome to Technology Blog'
            else:
...
class RegisterView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            user_obj = User.objects.create(email=data.get('username'), first_name=data.get('firstname'),
                                           last_name=data.get('lastname'), username=data.get('username'))
